...
#ifndef __BH_VEM_INTRO_H
#define __BH_VEM_INTRO_H
 ...
 */
DLLEXPORT bh_error bh_vem_intro_init(bh_component *self);
 ...
 * @return Error codes (BH_SUCCESS)
 */
DLLEXPORT bh_error bh_vem_intro_shutdown(void);
 ...
 * @return Error codes (BH_SUCCESS)
 */
DLLEXPORT bh_error bh_vem_intro_execute(bh_intp count,
 ...
 * @return Error codes (BH_SUCCESS)
 */
DLLEXPORT bh_error bh_vem_intro_reg_func(const char *fun, bh_intp *id);

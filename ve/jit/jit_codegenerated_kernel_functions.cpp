...
//~ void kernel_func_1158854506_0(cphvb_array** as,cphvb_constant** cs, cphvb_index skip, cphvb_index limit) {
        ...
        //~ cphvb_index coord[2];
        //~ memset(coord, 0, 2 * sizeof(cphvb_index));
//~ cphvb_int32* DA0 = (cphvb_int32*) cphvb_base_array( as[1])->data;
//~ cphvb_index OffA0;
//~ cphvb_bool* DA1 = (cphvb_bool*) cphvb_base_array( as[0])->data;
//~ cphvb_index OffA1;
//~ cphvb_int32* DC0 = (cphvb_int32*) &cs[0]->value;
        //~ int j=0, i=0;
        //~ if (skip>0) {                                // Create coord based on skip
            //~ while(ec<skip) {
                //~ ec += as[0]->shape[last_dim];
